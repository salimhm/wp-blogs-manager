...
urlpatterns = [
    ...
    path('sites/<str:site_domain>/', views.site_detail, name='site_detail'),
    path('sites/<str:site_domain>/edit/', views.edit_site, name='edit_site'),
    path('sites/<str:site_domain>/delete/', views.delete_site, name='delete_site'),
    path('sites/<str:site_domain>/verify/', views.verify_site, name='verify_site'),
    path('sites/<str:site_domain>/logs/', views.site_logs, name='site_logs'),
    ...
    # Articles
    path('sites/<str:site_domain>/articles/', views.article_list, name='article_list'),
    path('sites/<str:site_domain>/articles/write/', views.write_articles, name='write_articles'),
    path('sites/<str:site_domain>/articles/<int:article_id>/', views.article_detail, name='article_detail'),
    path('sites/<str:site_domain>/articles/<int:article_id>/publish/', views.publish_article, name='publish_article'),
    ...
    path('sites/<str:site_domain>/daily-run/<int:run_id>/stop/', views.stop_daily_run, name='stop_daily_run'),
    path('sites/<str:site_domain>/daily-run/<int:run_id>/pause/', views.pause_daily_run, name='pause_daily_run'),
    path('sites/<str:site_domain>/daily-run/<int:run_id>/resume/', views.resume_daily_run, name='resume_daily_run'),
    path('sites/<str:site_domain>/daily-run/<int:run_id>/cancel/', views.cancel_daily_run, name='cancel_daily_run'),
